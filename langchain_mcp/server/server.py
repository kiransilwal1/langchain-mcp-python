#!/Users/kiransilwal/llm-venv/bin/python
...
PATH = "/Users/kiransilwal/MachineLearning/mcp/langchain-mcp/"
...
@mcp.tool()
def worldlink_query_tool(query: str):
    """
    Query the Worldlink documentation using a retriever.
...
@mcp.resource("docs://worldlink/full")
def get_all_worldlink_docs() -> str:
    """
